//
//  AttachmentsControllerViewModel.h
//  PhotoLibPOC
//
...
@interface AttachmentsControllerViewModel : NSObject
...
/**
 Returns bool value to determine If a view at specified section can have bottom border line.
 
 @param section The index of the section whose header size is being requested.
 @return YES if the item is allowed to have bottom border or NO if it is not.
 */
